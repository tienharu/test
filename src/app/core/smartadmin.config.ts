...
export const config: any = {
  ...
  maxOpenedPrograms: 10,


  skins: [
    {
      name: "smart-style-3",//default skin
      logo: "assets/img/logo-hr.png",
      logo_left: "assets/img/logo_l1.png",
      skinBtnClass: "btn btn-xs btn-block txt-color-white margin-top-5",
      style: {
        background: '#2c3742'//f78c40
      },
      label: "Smart Standard"
    },
    {
      name: "smart-style-0",
      logo: "assets/img/logo-gray.png",
      logo_left: "assets/img/logo-g-l.png",
...

    {
      ...
      logo_left: "assets/img/logo-d-l.png",
