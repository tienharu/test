...
@Component({
  selector: 'sa-style-master-search-popup',
  templateUrl: './style-master-search-popup.component.html',
  styleUrls: ['./style-master-search-popup.component.css']
})
export class StyleMasterSearchPopupComponent extends BasePage implements OnInit {
  //-----------------------------------------
