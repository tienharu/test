...
@Component({
  selector: 'sa-approval-popup-infor',
  templateUrl: './approval-popup-infor.component.html',
  styleUrls: ['./approval-popup-infor.component.css', '../../../../../assets/css/smart-table.scss','../approval-line-registration.component.css']
})
export class ApprovalLineRegiatrationComponent extends DefaultEditor implements OnInit, AfterViewInit {
  ...
  onChange(item) {
    ...
    var rows = this.cell.getRow();
        rows.cells[3].newValue = item.user_id;
        rows.cells[4].newValue = item.position_gen_cd;
  }
}
