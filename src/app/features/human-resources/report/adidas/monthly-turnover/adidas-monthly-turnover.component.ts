...
@Component({
    selector: "",
    templateUrl: "./adidas-monthly-turnover.component.html",
    styleUrls: ["./adidas-monthly-turnover.component.css"]
  })
  export class AdidasMonthlyTurnoverComponent extends BasePage implements OnInit {
    years: any = [];
    ...
    exportXLSX():void {
      if(this.month)
      {
        ...
        this.monthlyOvertimeService.DownLoadAdidasMonthlyOverTime(this.orgid, this.calendar.getFullYear(), this.calendar.getMonth() + 1).then(res=>{
